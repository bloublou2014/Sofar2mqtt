...
void runStateME3000() {
  switch (INVERTER_RUNNINGSTATE)
  {
    ...
    case 2:
      printScreenText("Charging", String(batteryWatts()) + "W");
    ...
    case 4:
      printScreenText("Discharging", String(-1 * batteryWatts()) + "W");
      if (tftModel) tft.fillCircle(120, 290, 10, ILI9341_GREEN);
      break;
    ...
    case 2:
      {
        ...
        if (w == 0) {
          ...
          printScreenText("Charging", String(w) + "W");
          if (tftModel) tft.fillCircle(120, 290, 10, ILI9341_BLUE);
        } else {
          printScreenText("Discharging", String(w * -1) + "W");
          if (tftModel) tft.fillCircle(120, 290, 10, ILI9341_GREEN);
        }
      }
      break;
